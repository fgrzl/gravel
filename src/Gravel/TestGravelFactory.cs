...
namespace Gravel.Tests
{
    ...
    internal class TestGravelFactory : IGravelFactory
    {
    ...
    internal class TestGravelDb : IGravelDb
    {
        private readonly SortedDictionary<byte[], byte[]> _store = new(new ByteArrayComparer());
    ...
    internal class GravelIterator : IGravelIterator
    {
        private readonly byte[][] _keys;
        private readonly SortedDictionary<byte[], byte[]> _store;
    ...
    internal class TestMemTable : IMemTable
    {
