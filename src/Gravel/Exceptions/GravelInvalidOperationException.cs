...
/// <summary>
///     Gravel-specific <see cref="InvalidOperationException" /> so callers can catch either the base exception or this
///     more specific type.
/// </summary>
public class GravelInvalidOperationException : InvalidOperationException
{
    ...
    /// <summary>
    ///     Initializes a new instance of <see cref="GravelInvalidOperationException" /> with a specified error message and
    ///     inner exception.
    /// </summary>
    /// <param name="message">The error message.</param>
