...
public class GravelArgumentOutOfRangeException : ArgumentOutOfRangeException
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GravelArgumentOutOfRangeException"/> class with the name of the parameter that causes this exception.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GravelArgumentOutOfRangeException"/> class with the parameter name and a specified error message.
    /// </summary>
    /// <param name="paramName">The name of the parameter that caused the exception.</param>
